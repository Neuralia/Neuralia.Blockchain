...
namespace Neuralia.Blockchains.Common.Classes.Blockchains.Common.DataStructures.Validation {
	...
	public abstract class EventValidationErrorCodeBase<T> : SimpleUShort<T>, IEventValidationErrorCodeBase
	...
	public class EventValidationErrorCodes<T> : UShortConstantSet<T>
		...
		protected EventValidationErrorCodes() : base(10_000) {
			...
			this.CreateBaseConstant(ref this.GOSSIP_PRESENTATION_TRANSACTIONS_NOT_ALLOWED, nameof(this.GOSSIP_PRESENTATION_TRANSACTIONS_NOT_ALLOWED));
