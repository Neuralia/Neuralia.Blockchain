...
namespace Neuralia.Blockchains.Common.Classes.Blockchains.Common.Wallet.Account {
	...
	public interface IWalletAccount {
		...
		IEncryptorParameters TransactionHistoryFileEncryptionParameters { get; set; }
		IEncryptorParameters ElectionHistoryFileEncryptionParameters { get; set; }
		IEncryptorParameters ElectionStatisticsFileEncryptionParameters { get; set; }
		IEncryptorParameters SnapshotFileEncryptionParameters { get; set; }
		IEncryptorParameters ElectionCacheFileEncryptionParameters { get; set; }
		
		SafeArrayHandle TransactionHistoryFileSecret { get; set; }
		SafeArrayHandle ElectionHistoryFileSecret { get; set; }
		SafeArrayHandle ElectionStatisticsFileSecret { get; set; }
		ByteArray SnapshotFileSecret { get; set; }
		ByteArray ElectionCacheFileSecret { get; set; }
	...
	public abstract class WalletAccount : IWalletAccount {
		...
		public virtual void ClearEncryptionParameters() {
			ClearTransactionHistoryFileEncryptionParameters();
			ClearElectionHistoryFileEncryptionParameters();
			ClearElectionStatisticsFileEncryptionParameters();
		...
		public virtual void InitializeNewEncryptionParameters(BlockchainServiceSet serviceSet, ChainConfigurations chainConfiguration) {
			InitializeNewTransactionHistoryFileEncryptionParameters(serviceSet, chainConfiguration);
			InitializeNewElectionHistoryFileEncryptionParameters(serviceSet, chainConfiguration);
			InitializeNewElectionStatisticsFileEncryptionParameters(serviceSet, chainConfiguration);
		...
		public IEncryptorParameters TransactionHistoryFileEncryptionParameters { get; set; }
		public IEncryptorParameters ElectionHistoryFileEncryptionParameters { get; set; }
		public IEncryptorParameters ElectionStatisticsFileEncryptionParameters { get; set; }
		
		public SafeArrayHandle TransactionHistoryFileSecret { get; set; }
		public SafeArrayHandle ElectionHistoryFileSecret { get; set; }
		public SafeArrayHandle ElectionStatisticsFileSecret { get; set; }
		...
		private void ClearTransactionHistoryFileEncryptionParameters() {
			this.TransactionHistoryFileEncryptionParameters = null;
			this.TransactionHistoryFileSecret = null;
		}
		
		private void ClearElectionHistoryFileEncryptionParameters() {
			this.ElectionHistoryFileEncryptionParameters = null;
			this.ElectionHistoryFileSecret = null;
		}
		
		private void ClearElectionStatisticsFileEncryptionParameters() {
			this.ElectionStatisticsFileEncryptionParameters = null;
			this.ElectionStatisticsFileSecret = null;
		}
		...
		private void InitializeNewTransactionHistoryFileEncryptionParameters(BlockchainServiceSet serviceSet, ChainConfigurations chainConfiguration) {
			// create those no matter what
			if(this.TransactionHistoryFileEncryptionParameters == null) {
				this.TransactionHistoryFileEncryptionParameters = FileEncryptorUtils.GenerateEncryptionParameters(chainConfiguration);
				byte[] secretKey = new byte[333];
				GlobalRandom.GetNextBytes(secretKey);
				this.TransactionHistoryFileSecret = SafeArrayHandle.WrapAndOwn(secretKey);
			}
		}
		
		private void InitializeNewElectionHistoryFileEncryptionParameters(BlockchainServiceSet serviceSet, ChainConfigurations chainConfiguration) {
			// create those no matter what
			if(this.ElectionHistoryFileEncryptionParameters == null) {
				this.ElectionHistoryFileEncryptionParameters = FileEncryptorUtils.GenerateEncryptionParameters(chainConfiguration);
				byte[] secretKey = new byte[333];
				GlobalRandom.GetNextBytes(secretKey);
				this.ElectionHistoryFileSecret = SafeArrayHandle.WrapAndOwn(secretKey);
			}
		}
		
		private void InitializeNewElectionStatisticsFileEncryptionParameters(BlockchainServiceSet serviceSet, ChainConfigurations chainConfiguration) {
			// create those no matter what
			if(this.ElectionStatisticsFileEncryptionParameters == null) {
				this.ElectionStatisticsFileEncryptionParameters = FileEncryptorUtils.GenerateEncryptionParameters(chainConfiguration);
				byte[] secretKey = new byte[333];
				GlobalRandom.GetNextBytes(secretKey);
				this.ElectionStatisticsFileSecret = SafeArrayHandle.WrapAndOwn(secretKey);
			}
		}
		...
		public class WalletAccountChainStateMiningCache {
			public Guid MiningPassword { get; set; } = Guid.Empty;
			
			public Guid MiningSecretCode { get; set; } = Guid.Empty;
		...
		public class AccountAppointmentDetails {
			...
			/// <summary>
			/// use to know when an appointment time window is seriously over during the puzzle window
			/// </summary>
