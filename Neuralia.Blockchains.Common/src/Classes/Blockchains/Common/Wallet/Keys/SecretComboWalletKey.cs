...
namespace Neuralia.Blockchains.Common.Classes.Blockchains.Common.Wallet.Keys {
	...
	public interface ISecretComboWalletKey : ISecretWalletKey, ISecretComboKey {
	...
	public class SecretComboWalletKey : SecretWalletKey, ISecretComboWalletKey {
		...
		protected override void SetFromWalletKey(IWalletKey other) {
			...
			if(other is ISecretComboWalletKey secretComboWalletKey) {
				this.PromisedNonce1 = secretComboWalletKey.PromisedNonce1;
				this.PromisedNonce2 = secretComboWalletKey.PromisedNonce2;
			}
		}
	}
}