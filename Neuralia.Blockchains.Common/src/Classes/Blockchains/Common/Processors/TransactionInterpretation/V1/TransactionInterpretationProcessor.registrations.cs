...
namespace Neuralia.Blockchains.Common.Classes.Blockchains.Common.Processors.TransactionInterpretation.V1 {
	...
	public abstract partial class TransactionInterpretationProcessor<CENTRAL_COORDINATOR, CHAIN_COMPONENT_PROVIDER, ACCOUNT_SNAPSHOT, STANDARD_ACCOUNT_SNAPSHOT, STANDARD_ACCOUNT_ATTRIBUTE_SNAPSHOT, JOINT_ACCOUNT_SNAPSHOT, JOINT_ACCOUNT_ATTRIBUTE_SNAPSHOT, JOINT_ACCOUNT_MEMBERS_SNAPSHOT, STANDARD_ACCOUNT_KEY_SNAPSHOT, ACCREDITATION_CERTIFICATE_SNAPSHOT, ACCREDITATION_CERTIFICATE_ACCOUNT_SNAPSHOT, CHAIN_OPTIONS_SNAPSHOT> : ITransactionInterpretationProcessor<CENTRAL_COORDINATOR, CHAIN_COMPONENT_PROVIDER, ACCOUNT_SNAPSHOT, STANDARD_ACCOUNT_SNAPSHOT, STANDARD_ACCOUNT_ATTRIBUTE_SNAPSHOT, JOINT_ACCOUNT_SNAPSHOT, JOINT_ACCOUNT_ATTRIBUTE_SNAPSHOT, JOINT_ACCOUNT_MEMBERS_SNAPSHOT, STANDARD_ACCOUNT_KEY_SNAPSHOT, ACCREDITATION_CERTIFICATE_SNAPSHOT, ACCREDITATION_CERTIFICATE_ACCOUNT_SNAPSHOT, CHAIN_OPTIONS_SNAPSHOT>
		...
		protected virtual async Task RegisterTransactionImpactSets() {
			...
			this.TransactionImpactSets.RegisterTransactionImpactSet<IStandardPresentationTransaction>((t, affectedSnapshots, lockContext) => {
				...
				if((parameters.operationModes == TransactionImpactSet.OperationModes.Real) && await this.centralCoordinator.ChainComponentProvider.AccountSnapshotsProviderBase.IsAccountTracked(t.AssignedAccountId).ConfigureAwait(false)) {
					// we dont need to set the keys in simulated mode.
			...
			this.TransactionImpactSets.RegisterTransactionImpactSet<IJointPresentationTransaction>((t, affectedSnapshots, lockContext) => {
			...
			this.TransactionImpactSets.RegisterTransactionImpactSet<IStandardAccountKeyChangeTransaction>((t, affectedSnapshots, lockContext) => {
			...
			}, collectStandardAccountKeyDictionaryFunc: (t, parameters, lockContext) => {
				List<KeyDictionaryMetadata> keys = new List<KeyDictionaryMetadata>();
			...
			// });
			//
			this.TransactionImpactSets.RegisterTransactionImpactSet<IGatedJudgementTransaction>((t, affectedSnapshots, lockContext) => {
			...
			this.TransactionImpactSets.RegisterTransactionImpactSet<IThreeWayGatedTransaction>((t, affectedSnapshots, lockContext) => {
			...
			this.TransactionImpactSets.RegisterTransactionImpactSet<IAccountResetWarningTransaction>((t, affectedSnapshots, lockContext) => {
				throw new UnrecognizedElementException(this.CentralCoordinator.ChainId, this.CentralCoordinator.ChainName);
			...
			this.TransactionImpactSets.RegisterTransactionImpactSet<IAccountResetTransaction>((t, affectedSnapshots, lockContext) => {
			...
			this.TransactionImpactSets.RegisterTransactionImpactSet<IChainAccreditationCertificateTransaction>((t, affectedSnapshots, lockContext) => {

				if(t.CertificateOperation != ChainAccreditationCertificateTransaction.CertificateOperationTypes.Create) {
					affectedSnapshots.accreditationCertificates.Add((int) t.CertificateId);
				}
				return Task.CompletedTask;
				...
				if(t.CertificateOperation == ChainAccreditationCertificateTransaction.CertificateOperationTypes.Create) {
					certificate = await parameters.snapshotCache.CreateNewAccreditationCertificateSnapshot((int) t.CertificateId, lockContext).ConfigureAwait(false);
				} else {
					certificate = await parameters.snapshotCache.GetAccreditationCertificateSnapshotModify((int) t.CertificateId, lockContext).ConfigureAwait(false);
				}

				certificate.CertificateId = (int) t.CertificateId;
			...
			this.TransactionImpactSets.RegisterTransactionImpactSet<IChainOperatingRulesTransaction>((t, affectedSnapshots, lockContext) => {
			...
			this.TransactionImpactSets.RegisterTransactionImpactSet<IGenesisModeratorAccountPresentationTransaction>((t, affectedSnapshots, lockContext) => {
			...
			this.TransactionImpactSets.RegisterTransactionImpactSet<IGenesisAccountPresentationTransaction>((t, affectedSnapshots, lockContext) => {
				affectedSnapshots.AddAccounts(t.ImpactedAccounts);
				
				return Task.CompletedTask;
			}, interpretTransactionStandardAccountKeysFunc: (t, parameters, lockContext) => {
				
				return Task.CompletedTask;

			});

			this.TransactionImpactSets.RegisterTransactionImpactSet<IModeratorKeyChangeTransaction>((t, affectedSnapshots, lockContext) => {
			...
			this.TransactionImpactSets.RegisterTransactionImpactSet<IAssignAccountCorrelationsTransaction>((t, affectedSnapshots, lockContext) => {
