...
namespace Neuralia.Blockchains.Common.Classes.Blockchains.Common.Workflows.Factories {
	...
	public interface IChainWorkflowFactory<CENTRAL_COORDINATOR, CHAIN_COMPONENT_PROVIDER> : IWorkflowFactory
		...
		IGenerateXmssKeyIndexNodeCacheWorkflow<CENTRAL_COORDINATOR, CHAIN_COMPONENT_PROVIDER> CreateGenerateXmssKeyIndexNodeCacheWorkflow(string accountCode, byte ordinal, long index, CorrelationContext correlationContext);
		...
		ISendAppointmentVerificationResultsMessageWorkflow<CENTRAL_COORDINATOR, CHAIN_COMPONENT_PROVIDER> CreateSendAppointmentVerificationResultsMessageWorkflow(DateTime appointmentz, CorrelationContext correlationContext);
	...
	public abstract class ChainWorkflowFactory<CENTRAL_COORDINATOR, CHAIN_COMPONENT_PROVIDER> : WorkflowFactory<IBlockchainEventsRehydrationFactory>, IChainWorkflowFactory<CENTRAL_COORDINATOR, CHAIN_COMPONENT_PROVIDER>
		...
		public abstract IGenerateXmssKeyIndexNodeCacheWorkflow<CENTRAL_COORDINATOR, CHAIN_COMPONENT_PROVIDER> CreateGenerateXmssKeyIndexNodeCacheWorkflow(string accountCode, byte ordinal, long index, CorrelationContext correlationContext);
		...
		public abstract ISendAppointmentVerificationResultsMessageWorkflow<CENTRAL_COORDINATOR, CHAIN_COMPONENT_PROVIDER> CreateSendAppointmentVerificationResultsMessageWorkflow(DateTime appointment, CorrelationContext correlationContext);
	}
}