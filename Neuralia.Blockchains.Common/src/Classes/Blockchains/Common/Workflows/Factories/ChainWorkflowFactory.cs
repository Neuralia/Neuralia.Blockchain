...
namespace Neuralia.Blockchains.Common.Classes.Blockchains.Common.Workflows.Factories {
	...
	public interface IChainWorkflowFactory<CENTRAL_COORDINATOR, CHAIN_COMPONENT_PROVIDER> : IWorkflowFactory
		...
		ISendAppointmentVerificationResultsMessageWorkflow<CENTRAL_COORDINATOR, CHAIN_COMPONENT_PROVIDER> CreateSendAppointmentVerificationResultsMessageWorkflow(DateTime appointment, CorrelationContext correlationContext);
