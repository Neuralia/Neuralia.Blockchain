...
namespace Neuralia.Blockchains.Common.Classes.Blockchains.Common.Elections.Processors {
	public interface IElectionProcessor {
		ElectedCandidateResultDistillate PerformActiveElection(int maturityBlockHash, BlockElectionDistillate blockElectionDistillate, AccountId miningAccount, Enums.MiningTiers miningTier);
		...
		SafeArrayHandle DetermineIfElected(BlockElectionDistillate blockElectionDistillate, AccountId miningAccount, Enums.MiningTiers miningTier);
