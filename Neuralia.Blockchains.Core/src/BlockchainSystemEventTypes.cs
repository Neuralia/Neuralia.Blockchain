...
namespace Neuralia.Blockchains.Core {
	...
	public class BlockchainSystemEventTypes : UShortConstantSet<BlockchainSystemEventType> {
		...
		public readonly BlockchainSystemEventType THSTrigger;
		public readonly BlockchainSystemEventType THSBegin;
		public readonly BlockchainSystemEventType THSIteration;
		public readonly BlockchainSystemEventType THSRound;
		public readonly BlockchainSystemEventType THSSolution;
		...
		protected BlockchainSystemEventTypes() : base(1000) {
			...
			this.THSTrigger = this.CreateBaseConstant();
			this.THSBegin = this.CreateBaseConstant();
			this.THSRound = this.CreateBaseConstant();
			this.THSIteration = this.CreateBaseConstant();
			this.THSSolution = this.CreateBaseConstant();
