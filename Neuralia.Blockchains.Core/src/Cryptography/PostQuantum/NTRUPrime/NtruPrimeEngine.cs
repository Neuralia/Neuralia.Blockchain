...
namespace Neuralia.Blockchains.Core.Cryptography.PostQuantum.NTRUPrime {
	...
	public unsafe class NtruPrimeEngine : IDisposableExtended {
		...
		/// </remarks>
		/// <param name="x">x must not be close to top int16</param>
		...
		#region Arithmetic mod q

		/// <summary>
		/// Always represented as -q12...q12 
		/// so ZZ_fromFq is a no-op
		/// </summary>
		/// <param name="x">x must not be close to top int32</param>
		...
		/// <summary>
		/// Underlying SHA512 hash function
		/// </summary>		
		/// <param name="output"></param>
		/// <param name="b"></param>
		/// <param name="input"></param>
		...
		/// <summary>
		/// Generate Higher-level randomness
		/// </summary>
		/// <param name="output"></param>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		#region Streamlined NTRU Prime Core plus encoding

		/// <summary>
		/// Produce NTRUP Key Gen 
		/// </summary>
		/// <param name="pk"></param>
		/// <param name="sk"></param>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		/// <summary>
		/// NTRUP Encrypt function:  C = ZEncrypt(r,pk)
		/// </summary>
		/// <param name="C"></param>
		/// <param name="r"></param>
		/// <param name="pk"></param>
		...
		/// <summary>
		/// NTRUP Decrypt function: r = ZDecrypt(C,sk)
		/// </summary>
		/// <param name="r"></param>
		/// <param name="C"></param>
		/// <param name="sk"></param>
		...
		/// <summary>
		/// Hash confirm: h = HashConfirm(r,pk,cache)
		/// </summary>
		/// <param name="h"></param>
		/// <param name="r"></param>
		/// <param name="pk"></param>
		...
		/// <summary>
		/// Generate Hash Session:  k = HashSession(b,y,z)
		/// </summary>
		/// <param name="k"></param>
		/// <param name="b"></param>
		/// <param name="y"></param>
		...
		/// <summary>
		/// Generate symmetric key for Key encapsulation mechanisms: pk,sk = KEM_KeyGen()
		/// </summary>
		...
		/// <summary>
		/// Hide bytes of randomness: c,r_enc = Hide(r,pk,cache)
		/// </summary>
		/// <param name="c"></param>
		/// <param name="r_enc"></param>
		/// <param name="r"></param>
		/// <param name="pk"></param>
		/// <param name="cache"></param>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		/// <summary>
		/// Encapsulate and return ciphertext
		/// </summary>
		/// <param name="c">ciphertext</param>
		/// <param name="k">plaintext</param>
		/// <param name="pk">public key</param>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		/// <summary>
		/// Ciphertext diff: 0 if matching ciphertext+confirm, else -1
		/// </summary>
		/// <param name="c"></param>
		/// <param name="c2"></param>
		/// <returns></returns>
		...
		/// <summary>
		/// Decapsulation: k = Decap(c,sk)
		/// </summary>
		/// <param name="k">plaintext</param>
		/// <param name="c">ciphertext</param>
		/// <param name="sk">scret key</param>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
