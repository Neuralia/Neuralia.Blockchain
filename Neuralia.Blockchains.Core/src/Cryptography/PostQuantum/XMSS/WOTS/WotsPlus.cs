...
namespace Neuralia.Blockchains.Core.Cryptography.PostQuantum.XMSS.WOTS {
	...
	public unsafe class WotsPlus : IDisposableExtended {
		...
		private ByteArray GeneratePrivateKey(ByteArray privateSeed, short nonce2, OtsHashAddress adrs) {
		...
		public ByteArray[] GeneratePseudorandomPrivateKeys(ByteArray secretSeed, short nonce2, OtsHashAddress adrs) {
		...
		public ByteArray[] GeneratePublicKey(ByteArray privateSeed, ByteArray publicSeed, short nonce2, XMSSEngine.ThreadContext threadContext) {
		...
		public ByteArray[] GenerateSignature(ByteArray message, ByteArray privateSeed, ByteArray publicSeed, short nonce2, OtsHashAddress adrs) {
