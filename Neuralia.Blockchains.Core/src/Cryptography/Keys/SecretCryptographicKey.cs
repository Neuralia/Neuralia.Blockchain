...
namespace Neuralia.Blockchains.Core.Cryptography.Keys {
	...
	public interface ISecretCryptographicKey : ISecretKey, ICryptographicKey {
	...
	/// </summary>
	public class SecretCryptographicKey : CryptographicKey, ISecretCryptographicKey {
		...
		public SecretCryptographicKey(ISecretKey other) : base(other) {
		}
